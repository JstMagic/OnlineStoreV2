...
- 2026-07-18: In the homepage hero (apps/web/components/HeroSection.tsx), change the heading text from "New Season Arrivals" to "Summer Collection 2026".  — apps/web/components/HeroSection.tsx, package-lock.json
